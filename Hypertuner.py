...
class Tuner:
    ...
    def tune(self, to_opt: str, direction: str):
        ...
        if to_opt == 'accuracy':
            self.logger.info('Optimizing L1 for accuracy.')
        ...
        if to_opt == 'precision':
            self.logger.info('Optimizing L1 for precision.')
        ...
        if to_opt == 'fscore':
            self.logger.info('Optimizing L1 for fscore.')
        ...
        if to_opt == 'tpr':
            self.logger.info('Optimizing L1 for tpr.')
        ...
        if to_opt == 'tnr':
            self.logger.info('Optimizing L1 for tnr.')
        ...
        if to_opt == 'fpr':
            self.logger.info('Optimizing L1 for fpr.')
        ...
        if to_opt == 'fnr':
            self.logger.info('Optimizing L1 for fnr.')
    ...
    def __train_new_hps(self, classifier_name: str, parameters: dict):
        ...
        if classifier_name == 'RandomForest':
            ...
            self.logger.info('Trained a new RandomForest classifier.')
            ...
            self.logger.info('Trained a new SVM classifier.')
